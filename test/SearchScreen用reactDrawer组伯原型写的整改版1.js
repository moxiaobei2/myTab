            ...
            .then((result) => {
                if (result){
                    ...
                    result.sections.forEach(function(e,index){
                        ...
                        e.key="section_"+index;
                        e.brands.forEach(function(eb,ebindex){
                            eb.key="brands_"+ebindex;
                        });
                    });
        ...
        return (
            <View style={[styles.flex,styles.container]}>
                ...
                <Drawer
                    ...
                    content={this.getSerialBarContent()}
                    >
                                        ...
                                        </View>
                                        {
                                            e.brands.map(function(eb,ebii){
                                                return (
                                                    ...
                                                    parent.setState({"brandId":null})
                                                          parent.setState({"brandId":eb.id});
                                                          console.log("brandId====>"+parent.state.brandId)
