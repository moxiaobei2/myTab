...
var searchScreen=React.createClass({
    ...
    _renderNavigationView: function() {
        return (
            this.state.brandId != null ? <SerialsBar mainNavigator={this.props.mainNavigator} brandId={this.state.brandId}  setSelectedSerial={this.props.setSelectedSerial}/> :
        ...
        return (
            <View style={[styles.flex,styles.container]}>
                ...
                <DrawerLayoutAndroid
                    ...
                    renderNavigationView={parent._renderNavigationView}>
                                            ...
                                            e.brands.map(function(eb,ebii){
                                                ...
                                                return (
                                                    <TouchableOpacity key={brandKey} style={[styles.flex,styles.row_bottom1]} onPress={() => {
                                                           parent.setState({"brandId":null});//最终实现了这个功能
